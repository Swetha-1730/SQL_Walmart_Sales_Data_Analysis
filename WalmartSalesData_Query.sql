...
-----------------------------------------------------FEATURE ENGINEERING--------------------------------------------------------
--Run the query to check the Time of the day considering the time-----
...
--Run the query to check the day considering the date-----
...
SET day_name = TO_CHAR(date, 'Day');
                     ...
                     ------------------------------------------------------------------------------------
--Run the query to check the month considering the date---
...
-- Q9) Fetch each product line and add a column to those product 
...
SELECT customer_type,count(*) as countFROM sales
GROUP BY customer_type
ORDER BY count DESC;
